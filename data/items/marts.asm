...
CeruleanMartClerkText::
	script_mart POKE_BALL, POTION, INF_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

UnusedBikeShopClerkText:: ; unreferenced
	script_mart BICYCLE

VermilionMartClerkText::
	script_mart POKE_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, INF_REPEL
